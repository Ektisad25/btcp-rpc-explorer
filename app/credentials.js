...
module.exports = {
	rpc: {
		...
		port: btcUri.port || process.env.BTCEXP_BITCOIND_PORT || 13495,
		username: btcAuth[0] || process.env.BTCEXP_BITCOIND_USER,
		password: btcAuth[1] || process.env.BTCEXP_BITCOIND_PASS,
		cookie: btcUri.query.cookie || process.env.BTCEXP_BITCOIND_COOKIE || path.join(os.homedir(), '.bitcoinpurple', '.cookie'),
